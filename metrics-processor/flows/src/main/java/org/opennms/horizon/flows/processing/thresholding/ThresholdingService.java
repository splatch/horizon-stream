...
package org.opennms.horizon.flows.processing.thresholding;


import org.opennms.horizon.flows.processing.impl.ServiceParameters;
...
public interface ThresholdingService {
     ...
     *            Must not be null. Required by some existing {CollectionResource} objects to evaluate whether to apply thresholds when accepting a { CollectionSet}.
     *            If your {CollectionResource} does not require this, pass an empty { ServiceParameters} object.
