...
public class ProcessingOptions {
    ...
    public final List<PackageConfig> packages;
    ...
    public static class Builder {
        ...
        private List<PackageConfig> packages = Lists.newArrayList();
        ...
        public Builder setPackages(final List<PackageConfig> packages) {
