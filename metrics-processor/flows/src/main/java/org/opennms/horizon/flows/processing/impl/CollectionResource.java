 ...
 * @version $Id: $
 */
public interface CollectionResource extends ResourceIdentifier, CollectionVisitable {
     ...
     * For Generic resources, this will be some identifying label, probably the index in the table.
     ...
     * 
     * @return a {@link TimeKeeper} object or null to indicate thatDefaultTimeKeeper should be used.
     */
