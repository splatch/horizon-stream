...
public class CsvClassificationRuleProvider implements ClassificationRuleProvider {

    private String path;
    private CsvService csvService;
    public CsvClassificationRuleProvider(final String path, final CsvService csvService){
    ...
    public List<Rule> getRules() {
        ...
        return csvService.parseCSV(group, ClassLoader.getSystemResourceAsStream(path), true).getRules();
    }
}
