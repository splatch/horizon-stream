 ...
 * @version $Id: $
 */
public class AttributeGroup implements CollectionVisitable {
     ...
     *
     * @param resource a {@link CollectionResource} object.
     ...
     * <p>getResource</p>
     *
     * @return a {@link CollectionResource} object.
     */
     ...
     * <p>addAttribute</p>
     *
     * @param attr a {@link CollectionAttribute} object.
     */
     ...
     * <p>visit</p>
     *
     * @param visitor a {@link CollectionSetVisitor} object.
     */
    @Override
    ...
    protected boolean doShouldPersist() {
        return AttributeGroupType.IF_TYPE_IGNORE.equalsIgnoreCase(getIfType()) || AttributeGroupType.IF_TYPE_ALL.equalsIgnoreCase(getIfType());
    }
     ...
     * <p>getGroupType</p>
     *
     * @return a {@link AttributeGroupType} object.
     */
