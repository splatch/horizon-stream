...
package org.opennms.horizon.flows.processing.criteria.restrictions;
...
public abstract class Restrictions {
    ...
    public static AttributeRestriction sql(final String sql, Object parameter, SqlRestriction.Type type) {
        return new SqlRestriction(sql, parameter, type);
    }

    public static AttributeRestriction sql(final String sql, Object[] parameters, SqlRestriction.Type[] types) {
