...
public class Netflow9ConverterTest {
    ...
    public void canParseNetflow9Flows() {
        ...
        assertEquals(flow.getSrcPort(), 137);
        assertEquals(flow.getDstAddr(), "10.1.20.127");
        assertEquals(flow.getDstAddrHostname(), Optional.empty());
        assertEquals(flow.getDstPort(), 137);
        assertEquals(flow.getProtocol(), 17); // UDP
        assertEquals(flow.getBytes(), 156L);
        assertEquals(flow.getInputSnmp(), 369098754);
        assertEquals(flow.getOutputSnmp(), 0);
        ...
        assertEquals(flow.getPackets(), 2L);
