...
public class MockInterfaceToNodeCache extends AbstractInterfaceToNodeCache {
    ...
    @Override
    public boolean setNodeId(String location, InetAddress ipAddr, long nodeId, String tenantId) {
        return keyToEntry.put(new Key(location, ipAddr), new Entry(nodeId, 0L, tenantId)) != null;
    }
