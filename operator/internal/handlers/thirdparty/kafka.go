...
func (h *KafkaHandler) UpdateConfig(values values.TemplateValues) error {
    ...
    h.AddToTemplates(handlers.Filepath("kafka/kafka-service.yaml"), values, &service)
    h.AddToTemplates(handlers.Filepath("kafka/kafka-deployment.yaml"), values, &deployment)
