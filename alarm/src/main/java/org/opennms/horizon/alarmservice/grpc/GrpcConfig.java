...
public class GrpcConfig {
    ...
    public GrpcServerManager startServer(AlarmGrpcService alarmGrpc, AlarmConfigurationGrpcService alarmConfigurationGrpc, AlarmServerInterceptor interceptor) {
        GrpcServerManager manager = new GrpcServerManager(port, interceptor);
        manager.startServer(alarmGrpc, alarmConfigurationGrpc);
        return manager;
    }
}
