...
public class TrapEventForwarder {
    ...
    public void sendEvents(EventLog eventLog, String tenantId) {
        ...
        producerRecord.headers().add(new RecordHeader(GlobalConstants.TENANT_ID_KEY, tenantId.getBytes(StandardCharsets.UTF_8)));
    ...
    public void sendInternalEvents(Event event, String tenantId) {
        ...
        record.headers().add(new RecordHeader(GlobalConstants.TENANT_ID_KEY, tenantId.getBytes(StandardCharsets.UTF_8)));
