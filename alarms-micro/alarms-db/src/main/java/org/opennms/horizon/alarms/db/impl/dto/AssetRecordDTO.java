...
public class AssetRecordDTO implements Serializable {
    ...
    private GeolocationDTO m_geolocation = new GeolocationDTO();

    /**
     * default constructor
     */
    public AssetRecordDTO() {
    }
    ...
    /**
     * PROXY METHOD: do not delete until {@link GeolocationDTO} is truly a separate table, or projection mapping will fail.
     */
    @Transient
    @Deprecated
    @XmlElement
    ...
    public boolean equals(final Object obj) {
        ...
        final AssetRecordDTO cmpAsset = (AssetRecordDTO) obj;
     ...
     *
     * @param newRecord a {@link AssetRecordDTO} object.
     */
    public void mergeRecord(AssetRecordDTO newRecord) {

        if (!this.equals(newRecord)) {
            return;
        }

        GeolocationDTO toGeolocation = this.getGeolocation();
        if (toGeolocation == null) {
            toGeolocation = new GeolocationDTO();
            this.setGeolocation(toGeolocation);
        }
        final GeolocationDTO fromGeolocation = newRecord.getGeolocation();
