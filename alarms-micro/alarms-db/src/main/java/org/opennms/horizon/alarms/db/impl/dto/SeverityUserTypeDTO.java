...
public class SeverityUserTypeDTO implements UserType {

    /**
     * A public default constructor is required by Hibernate.
     */
    public SeverityUserTypeDTO() {}
    ...
    public Object deepCopy(final Object value) throws HibernateException {
        if (value == null) {
            return null;
        } else if (value instanceof SeverityDTO) {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws HibernateException, SQLException {
        return SeverityDTO.get(rs.getInt(names[0]));
    }
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {
        if (value == null) {
            ...
            st.setInt(index,((SeverityDTO)value).getId());
    ...
    @Override
    public Class<SeverityDTO> returnedClass() {
        return SeverityDTO.class;
    }
