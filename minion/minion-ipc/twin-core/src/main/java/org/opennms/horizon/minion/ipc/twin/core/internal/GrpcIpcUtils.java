...
public class GrpcIpcUtils {
    ...
    public static SslContextBuilder buildSslContext(Properties properties) throws SSLException {
        ...
        if (!isNullOrEmpty(trustCertCollectionFilePath)) {
            builder.trustManager(new File(trustCertCollectionFilePath));
        }
        if (!isNullOrEmpty(clientCertChainFilePath) && !isNullOrEmpty(clientPrivateKeyFilePath)) {
            builder.keyManager(new File(clientCertChainFilePath), new File(clientPrivateKeyFilePath));
        } else if (!isNullOrEmpty(clientCertChainFilePath) || !isNullOrEmpty(clientPrivateKeyFilePath)) {
