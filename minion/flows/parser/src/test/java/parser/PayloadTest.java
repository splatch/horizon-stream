    ...
    public void outputPayloadTest() throws IOException, URISyntaxException {
        execute("/flows/nf9_broken.dat", buffer -> {
            try {
                ...
                final parser.netflow9.proto.Header h1 =
                        new parser.netflow9.proto.Header(slice(buffer, parser.netflow9.proto.Header.SIZE));
                final parser.netflow9.proto.Packet p1 =
                        new parser.netflow9.proto.Packet(session, h1, buffer);
