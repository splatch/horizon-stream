...
package parser.transport;

import static parser.transport.MessageUtils.first;
import static parser.transport.MessageUtils.getDoubleValue;
import static parser.transport.MessageUtils.getInetAddress;
import static parser.transport.MessageUtils.getLongValue;
import static parser.transport.MessageUtils.getUInt32Value;
import static parser.transport.MessageUtils.getUInt64Value;
import static parser.transport.MessageUtils.setDoubleValue;
import static parser.transport.MessageUtils.setIntValue;
import static parser.transport.MessageUtils.setLongValue;

import java.net.InetAddress;

import com.google.protobuf.UInt32Value;

import parser.RecordEnrichment;
import parser.flowmessage.Direction;
import parser.flowmessage.FlowMessage;
import parser.flowmessage.NetflowVersion;
import parser.flowmessage.SamplingAlgorithm;
