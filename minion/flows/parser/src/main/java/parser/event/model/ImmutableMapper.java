...
package parser.event.model;

import java.util.stream.Collectors;

import parser.event.AlarmData;
import parser.event.Autoacknowledge;
import parser.event.Autoaction;
import parser.event.Correlation;
import parser.event.Event;
import parser.event.Forward;
import parser.event.Logmsg;
import parser.event.ManagedObject;
import parser.event.Mask;
import parser.event.Maskelement;
import parser.event.Operaction;
import parser.event.Parm;
import parser.event.Script;
import parser.event.Snmp;
import parser.event.Tticket;
import parser.event.UpdateField;
import parser.event.Value;
