...
import static parser.InetAddressUtils.addr;
import static parser.InetAddressUtils.str;
import static parser.event.model.StringUtils.equalsTrimmed;
...
import parser.event.model.IEvent;
...
public class Event implements Serializable {
    ...
    public Parm getParmTrim(String key) {
        ...
        for (final Parm parm : _parms) {
            if (equalsTrimmed(parm.getParmName(), key)) {
                return parm;
            }
        }
