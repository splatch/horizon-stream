...
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.AlarmData;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Autoacknowledge;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Autoaction;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Correlation;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Event;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Forward;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Logmsg;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.ManagedObject;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Mask;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Maskelement;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Operaction;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Parm;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Script;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Snmp;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Tticket;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.UpdateField;
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.Value;
