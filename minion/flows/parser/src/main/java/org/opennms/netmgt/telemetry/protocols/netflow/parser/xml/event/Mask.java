...
import org.opennms.netmgt.telemetry.protocols.netflow.parser.xml.event.model.IMaskElement;
...
public class Mask implements Serializable {
    ...
    public static Mask copyFrom(IMask source) {
        ...
        mask.getMaskelementCollection().addAll(
                source.getMaskelementCollection().stream().map((IMaskElement copy) -> Maskelement.copyFrom(copy)).collect(Collectors.toList()));
        return mask;
    }
    ...
    throws IndexOutOfBoundsException {
        ...
        return _maskelementList.get(index);
    }
    ...
    public Maskelement[] getMaskelement(
        ...
        return this._maskelementList.toArray(array);
    }
