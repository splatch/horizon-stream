...
package org.opennms.horizon.minion.snmp.conf.xml;
...
public class AddressSnmpConfigVisitor extends AbstractSnmpConfigVisitor implements SnmpConfigVisitor {
    ...
    private Definition createDefinitionFromConfig(Configuration sourceConfig) {
        ...
        if (sourceConfig.hasMaxVarsPerPdu()) {
            ...
            definition.setMaxVarsPerPdu(SnmpConfiguration.DEFAULT_MAX_VARS_PER_PDU);
        }
        ...
        if (sourceConfig.hasMaxRepetitions()) {
            ...
            definition.setMaxRepetitions(SnmpConfiguration.DEFAULT_MAX_REPETITIONS);
        }
        ...
        if (sourceConfig.hasMaxRequestSize()) {
            ...
            definition.setMaxRequestSize(SnmpConfiguration.DEFAULT_MAX_REQUEST_SIZE);
        }
        ...
        if (sourceConfig.getAuthProtocol() != null) {
            ...
            definition.setAuthProtocol(SnmpConfiguration.DEFAULT_AUTH_PROTOCOL);
        }
        ...
        if (sourceConfig.getVersion() != null) {
            ...
            definition.setVersion(SnmpConfiguration.versionToString(SnmpConfiguration.VERSION1));
        }
        ...
        if (sourceConfig.getWriteCommunity() != null) {
            ...
            definition.setWriteCommunity(SnmpConfiguration.DEFAULT_WRITE_COMMUNITY);
        }
        ...
        if (sourceConfig.getReadCommunity() != null) {
            ...
            definition.setReadCommunity(SnmpConfiguration.DEFAULT_READ_COMMUNITY);
        }
        ...
        if (sourceConfig.hasTimeout()) {
            ...
            definition.setTimeout(SnmpConfiguration.DEFAULT_TIMEOUT);
        }
        ...
        if (sourceConfig.hasRetry()) {
            ...
            definition.setRetry(SnmpConfiguration.DEFAULT_RETRIES);
        }
        ...
        if (sourceConfig.hasPort()) {
            ...
            definition.setPort(SnmpConfiguration.DEFAULT_PORT);
        }
        ...
        if (sourceConfig.hasSecurityLevel()) {
            ...
            int securityLevel = SnmpConfiguration.NOAUTH_NOPRIV;
            if (isBlank(definition.getAuthPassphrase())) {
                securityLevel = SnmpConfiguration.NOAUTH_NOPRIV;
            } else if (isBlank(definition.getPrivacyPassphrase())) {
                securityLevel = SnmpConfiguration.AUTH_NOPRIV;
            } else {
                securityLevel = SnmpConfiguration.AUTH_PRIV;
            }
