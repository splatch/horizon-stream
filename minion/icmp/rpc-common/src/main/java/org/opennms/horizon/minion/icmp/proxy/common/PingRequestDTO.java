...
//    @XmlAttributeutebutettribute(name="system-id")
    private String systemId;

//    @XmlAttributettributelAttribute(name="retries")
    private int retries;

//    @XmlAttributettributelAttributettribute(name="timeout")
    private long timeout;

//    @XmlElementent(name="packet-size")
