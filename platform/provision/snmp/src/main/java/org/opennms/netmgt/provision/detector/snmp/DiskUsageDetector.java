...
/**
 * TODO: consider moving to its own module.  Keeping with the rest of the SNMP detectors for now because of the package
 * name and OSGI limitations on splitting packages across bundles, coupled with the use of classnames as strings.
 *
...
public class DiskUsageDetector extends SnmpDetector {
     ...
     * <p>setMatchType</p>
     *
     * @param matchType a {@link String} object.
     */
     ...
     *
     * @param hrStorageDescr a {@link String} object.
     */
