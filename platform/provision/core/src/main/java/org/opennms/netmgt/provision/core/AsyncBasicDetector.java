...
package org.opennms.netmgt.provision.core;

import java.util.regex.Pattern;

import org.apache.mina.core.session.IdleStatus;
import org.opennms.netmgt.provision.core.support.AsyncAbstractDetector;
import org.opennms.netmgt.provision.core.support.AsyncClientConversation;
import org.opennms.netmgt.provision.core.support.ConversationExchangeDefaultImpl;
...
public abstract class AsyncBasicDetector<Request, Response> extends AsyncAbstractDetector {
     ...
     * <p>expectBanner</p>
     *
     * @param bannerValidator a {@link ResponseValidator} object.
     */
     ...
     * @param responseValidator a {@link ResponseValidator} object.
     */
     ...
     * <p>getConversation</p>
     *
     * @return a {@link AsyncClientConversation} object.
     */
