...
import org.opennms.netmgt.provision.detector.ssh.support.ssh.InsufficientParametersException;
import org.opennms.netmgt.provision.detector.ssh.support.ssh.Ssh;
...
public class SshClient implements Client<NullRequest, SshResponse> {
     ...
     * <p>setBanner</p>
     *
     * @param banner a {@link String} object.
     */
     ...
     * <p>setMatch</p>
     *
     * @param match a {@link String} object.
     */
     ...
     * <p>setClientBanner</p>
     *
     * @param clientBanner a {@link String} object.
     */
