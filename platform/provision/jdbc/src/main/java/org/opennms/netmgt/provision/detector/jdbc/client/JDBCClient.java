...
public class JDBCClient implements Client<JDBCRequest, JDBCResponse> {
    ...
    public static final String OPENNMS_JDBC_HOSTNAME_MARKER = "OPENNMS_JDBC_HOSTNAME";
    ...
    public void connect(InetAddress address, int port, int timeout) throws IOException, Exception {
        ...
        String url = formatDbUrl(getUrl(), address.getCanonicalHostName());
     ...
     * <p>receiveBanner</p>
     *
     * @return a {@link JDBCResponse} object.
     ...
     * <p>sendRequest</p>
     *
     * @param request a {@link JDBCRequest} object.
     * @return a {@link JDBCResponse} object.
     * @throws IOException if any.
     * @throws Exception if any.
     */
...
//----------------------------------------
    ...
    private String formatDbUrl(String sourceUrl, String hostname) {
        return sourceUrl.replaceFirst(Pattern.quote(OPENNMS_JDBC_HOSTNAME_MARKER), hostname);
    }
}
