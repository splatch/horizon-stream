...
public class ForeignSourceDTO implements Serializable, Comparable<ForeignSourceDTO> {
    ...
    private List<PluginConfigDTO> m_detectors = new ArrayList<>();

    @XmlElementWrapper(name="policies")
    @XmlElement(name="policy")
    private List<PluginConfigDTO> m_policies = new ArrayList<>();
     ...
     *
     * @return the date stamp as a {@link Date}
     */
    @XmlTransient
     ...
     */
    @XmlTransient
    public List<PluginConfigDTO> getDetectors() {
        return m_detectors;
    }
    /**
     * <p>setDetectors</p>
     ...
     */
    public void setDetectors(final List<PluginConfigDTO> detectors) {
    ...
    public List<String> getDetectorNames() {
        ...
        for(PluginConfigDTO detector : m_detectors) {
     ...
     */
    @XmlTransient
    public List<PluginConfigDTO> getPolicies() {
        return m_policies;
    }
     ...
     * <p>setPolicies</p>
     *
     * @param policies a {@link List} object.
     */
    public void setPolicies(final List<PluginConfigDTO> policies) {
        m_policies = policies;
    }
    ...
    public PluginConfigDTO getDetector(final String detector) {
        for (final PluginConfigDTO pc : m_detectors) {
    ...
    public PluginConfigDTO getPolicy(final String policy) {
        for (final PluginConfigDTO pc : m_policies) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof ForeignSourceDTO)) return false;
        final ForeignSourceDTO other = (ForeignSourceDTO) obj;
        if (m_dateStamp == null) {
    ...
    @Override
    public int compareTo(final ForeignSourceDTO other) {
