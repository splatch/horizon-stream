...
import org.opennms.horizon.events.conf.xml.Decode;
import org.opennms.horizon.events.conf.xml.Maskelement;
import org.opennms.horizon.events.conf.xml.MatchResult;
import org.opennms.horizon.events.conf.xml.Parameter;
import org.opennms.horizon.events.conf.xml.Varbindsdecode;
import org.opennms.horizon.events.xml.AlarmData;
import org.opennms.horizon.events.xml.Autoaction;
...
import org.opennms.horizon.events.xml.Operaction;
import org.opennms.horizon.events.xml.Parm;
import org.opennms.horizon.events.xml.Tticket;
 ...
 */
public final class EventExpander implements org.opennms.horizon.events.api.EventExpander, EventProcessor {
    ...
    public EventExpander(MetricRegistry registry, EventConfDao eventConfDao, EventUtil util) {
        ...
        m_eventUtil = Objects.requireNonNull(util);
    }
     ...
     *
     */
    private org.opennms.horizon.events.xml.Mask transform(org.opennms.horizon.events.conf.xml.Mask src) {
        org.opennms.horizon.events.xml.Mask dest = new org.opennms.horizon.events.xml.Mask();

        for (final Maskelement confme : src.getMaskelements()) {
            // create new mask element
            org.opennms.horizon.events.xml.Maskelement me = new org.opennms.horizon.events.xml.Maskelement();
            // set name
     ...
     *
     */
    private org.opennms.horizon.events.xml.Snmp transform(org.opennms.horizon.events.conf.xml.Snmp src) {
        org.opennms.horizon.events.xml.Snmp dest = new org.opennms.horizon.events.xml.Snmp();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Logmsg transform(org.opennms.horizon.events.conf.xml.Logmsg src) {
        org.opennms.horizon.events.xml.Logmsg dest = new org.opennms.horizon.events.xml.Logmsg();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Correlation transform(org.opennms.horizon.events.conf.xml.Correlation src) {
        org.opennms.horizon.events.xml.Correlation dest = new org.opennms.horizon.events.xml.Correlation();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Autoaction transform(org.opennms.horizon.events.conf.xml.Autoaction src) {
        org.opennms.horizon.events.xml.Autoaction dest = new org.opennms.horizon.events.xml.Autoaction();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Operaction transform(org.opennms.horizon.events.conf.xml.Operaction src) {
        org.opennms.horizon.events.xml.Operaction dest = new org.opennms.horizon.events.xml.Operaction();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Autoacknowledge transform(org.opennms.horizon.events.conf.xml.Autoacknowledge src) {
        org.opennms.horizon.events.xml.Autoacknowledge dest = new org.opennms.horizon.events.xml.Autoacknowledge();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Tticket transform(org.opennms.horizon.events.conf.xml.Tticket src) {
        org.opennms.horizon.events.xml.Tticket dest = new org.opennms.horizon.events.xml.Tticket();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Forward transform(org.opennms.horizon.events.conf.xml.Forward src) {
        org.opennms.horizon.events.xml.Forward dest = new org.opennms.horizon.events.xml.Forward();
     ...
     *
     */
    private org.opennms.horizon.events.xml.Script transform(org.opennms.horizon.events.conf.xml.Script src) {
        org.opennms.horizon.events.xml.Script dest = new org.opennms.horizon.events.xml.Script();
     ...
     *
     */
    public static org.opennms.horizon.events.conf.xml.Event lookup(EventConfDao dao, Event event) {
        if (event == null) {
        ...
        //
        org.opennms.horizon.events.conf.xml.Event eConf = null;
    ...
    public void expandEvent(Event e) {
        org.opennms.horizon.events.conf.xml.Event econf = lookup(m_eventConfDao, e);
        ...
        if (econf != null) {
            ...
            if (e.getAlarmData() == null && econf.getAlarmData() != null) {
                ...
                final org.opennms.horizon.events.conf.xml.AlarmData econfAlarmData = econf.getAlarmData();
                ...
                List<org.opennms.horizon.events.conf.xml.UpdateField> updateFieldList = econfAlarmData.getUpdateFields();
                if (updateFieldList.size() > 0) {
                    List<UpdateField> updateFields = new ArrayList<>(updateFieldList.size());
                    for (org.opennms.horizon.events.conf.xml.UpdateField econfUpdateField : updateFieldList) {
                ...
                final org.opennms.horizon.events.conf.xml.ManagedObject econfMo = econfAlarmData.getManagedObject();
                if (econfMo != null) {
