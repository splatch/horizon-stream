...
//========================================
    ...
    private EventCollectionDTO dbLookupEventListWithCriteria(CriteriaBuilder builder) {
        OnmsEventCollection coll = new OnmsEventCollection(m_eventDao.findAll()); //(builder.toCriteria()));

        long totalCount = m_eventDao.countAll(); //(builder.count().toCriteria());
...
//        }
        ...
        OnmsEventCollection coll = new OnmsEventCollection(m_eventDao.findAll()); //(builder.toCriteria()));
        long count = m_eventDao.countAll(); // FIXME: OOPS: (builder.count().toCriteria());
