...
import static org.opennms.horizon.events.conf.xml.EventMatchers.varbind;
...
public class Varbind implements Serializable {
    ...
    public EventMatcher constructMatcher() {
        if (m_vbnumber == null) return org.opennms.horizon.events.conf.xml.EventMatchers.trueMatcher();
