...
public class Event implements Serializable, Comparable<Event> {
    ...
    private org.opennms.horizon.events.conf.xml.Mask m_mask;
    ...
    private org.opennms.horizon.events.conf.xml.Logmsg m_logmsg;
    ...
    private org.opennms.horizon.events.conf.xml.Correlation m_correlation;
    ...
    private List<org.opennms.horizon.events.conf.xml.Autoaction> m_autoactions = new ArrayList<>();
    ...
    private List<org.opennms.horizon.events.conf.xml.Parameter> m_parameters = new ArrayList<>();

    /**
     * The operator action to be taken when this event occurs
     */
    @XmlElement(name="operaction", required=false)
    private List<org.opennms.horizon.events.conf.xml.Operaction> m_operactions = new ArrayList<>();
    ...
    private org.opennms.horizon.events.conf.xml.Tticket m_tticket;

    /**
     * The forwarding information for this event
     */
    @XmlElement(name="forward", required=false)
    private List<org.opennms.horizon.events.conf.xml.Forward> m_forwards = new ArrayList<>();
    ...
    private List<org.opennms.horizon.events.conf.xml.Filter> m_filters;
    ...
    public org.opennms.horizon.events.conf.xml.Mask getMask() {
        return m_mask;
    }

    public void setMask(final org.opennms.horizon.events.conf.xml.Mask mask) {
        m_mask = mask;
    }
    ...
    public org.opennms.horizon.events.conf.xml.Logmsg getLogmsg() {
        return m_logmsg;
    }

    public void setLogmsg(final org.opennms.horizon.events.conf.xml.Logmsg logmsg) {
    ...
    public org.opennms.horizon.events.conf.xml.Correlation getCorrelation() {
        return m_correlation;
    }

    public void setCorrelation(final org.opennms.horizon.events.conf.xml.Correlation correlation) {
    ...
    public List<org.opennms.horizon.events.conf.xml.Autoaction> getAutoactions() {
        return m_autoactions;
    }

    public void setAutoactions(final List<org.opennms.horizon.events.conf.xml.Autoaction> autoactions) {
        if (m_autoactions == autoactions) return;
        m_autoactions.clear();
        if (autoactions != null) m_autoactions.addAll(autoactions);
    }

    public void addAutoaction(final org.opennms.horizon.events.conf.xml.Autoaction autoaction) {
        m_autoactions.add(autoaction);
    }

    public boolean removeAutoaction(final org.opennms.horizon.events.conf.xml.Autoaction autoaction) {
    ...
    public List<org.opennms.horizon.events.conf.xml.Parameter> getParameters() {
        return m_parameters;
    }

    public void setParameters(final List<org.opennms.horizon.events.conf.xml.Parameter> parameters) {
        if (m_parameters == parameters) return;
        m_parameters.clear();
        if (parameters != null) m_parameters.addAll(parameters);
    }

    public void addParameter(final org.opennms.horizon.events.conf.xml.Parameter parameter) {
        m_parameters.add(parameter);
    }

    public boolean removeParameter(final org.opennms.horizon.events.conf.xml.Parameter parameter) {
        return m_parameters.remove(parameter);
    }

    public List<org.opennms.horizon.events.conf.xml.Operaction> getOperactions() {
        return m_operactions;
    }

    public void setOperactions(final List<org.opennms.horizon.events.conf.xml.Operaction> operactions) {
        if (m_operactions == operactions) return;
        m_operactions.clear();
        if (operactions != null) m_operactions.addAll(operactions);
    }

    public void addOperaction(final org.opennms.horizon.events.conf.xml.Operaction operaction) {
        m_operactions.add(operaction);
    }

    public boolean removeOperaction(final org.opennms.horizon.events.conf.xml.Operaction operaction) {
    ...
    public org.opennms.horizon.events.conf.xml.Tticket getTticket() {
        return m_tticket;
    }

    public void setTticket(final org.opennms.horizon.events.conf.xml.Tticket tticket) {
        m_tticket = tticket;
    }

    public List<org.opennms.horizon.events.conf.xml.Forward> getForwards() {
        return m_forwards;
    }

    public void setForwards(final List<org.opennms.horizon.events.conf.xml.Forward> forwards) {
        if (m_forwards == forwards) return;
        m_forwards.clear();
        if (forwards != null) m_forwards.addAll(forwards);
    }

    public void addForward(final org.opennms.horizon.events.conf.xml.Forward forward) {
        m_forwards.add(forward);
    }

    public boolean removeForward(final org.opennms.horizon.events.conf.xml.Forward forward) {
    ...
    public List<org.opennms.horizon.events.conf.xml.Filter> getFilters() {
        return m_filters == null? Collections.emptyList() : m_filters;
    }

    public void setFilters(final List<org.opennms.horizon.events.conf.xml.Filter> filters) {
    ...
    public void addFilter(final org.opennms.horizon.events.conf.xml.Filter filter) {
        if (m_filters == null) m_filters = new ArrayList<>();
        m_filters.add(filter);
    }

    public boolean removeFilter(final org.opennms.horizon.events.conf.xml.Filter filter) {
    ...
    private EventMatcher constructMatcher() {
        if (m_mask == null || m_mask.getMaskelements().size() <= 0) {
            return m_uei == null ? org.opennms.horizon.events.conf.xml.EventMatchers.falseMatcher() : org.opennms.horizon.events.conf.xml.EventMatchers.ueiMatcher(m_uei);
        } else {
            return m_mask.constructMatcher();
        }
    }

    public org.opennms.horizon.events.conf.xml.MatchResult matches(final org.opennms.horizon.events.xml.Event matchingEvent) {
        if (m_matcher == null) {
            return org.opennms.horizon.events.conf.xml.MatchResult.FALSE;
        }
