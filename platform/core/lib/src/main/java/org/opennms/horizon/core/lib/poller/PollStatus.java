...
package org.opennms.horizon.core.lib.poller;
 ...
 *
 * MIGRATION NOTES:
 *      - Adding to core lib for use in the SSH detector without pulling in all of the poller couplings needed.
 *      - Commented-out the DB and XML parts as they are not needed for that purpose.
 *      - A better pattern of reuse can be considered when pulling in more of the poller.
 *      - A little refactoring here can go a long way
 */
// @Embeddable
