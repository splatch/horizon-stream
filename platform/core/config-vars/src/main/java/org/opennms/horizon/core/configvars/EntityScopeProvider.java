...
package org.opennms.horizon.core.configvars;
...
public interface EntityScopeProvider {
    ...
    Scope getScopeForInterface(Integer nodeId, String ipAddress);

    Scope getScopeForInterfaceByIfIndex(Integer nodeId, int ifIndex);
