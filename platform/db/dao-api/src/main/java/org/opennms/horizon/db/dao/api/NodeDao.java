...
import org.opennms.horizon.db.model.OnmsCategory;
...
public interface NodeDao extends OnmsDao<OnmsNode, Integer> {
     ...
     *
     * @return a {@link Map} containing all node ids and their associated labels.
     */
     ...
     * @param columnName a {@link String} object.
     * @param columnValue a {@link String} object.
     * @param categories a {@link Collection} object.
     * @return a {@link Collection} object.
     */
     ...
     *
     * @param rowCatNames a {@link Collection} object.
     * @param colCatNames a {@link Collection} object.
     * @return a {@link Collection} object.
     */
     ...
     *
     * @param groupName a {@link String} object.
     * @return a int.
     */
     ...
     * @param scanStamp a {@link Date} object.
     * @return a {@link List} object.
     */
     ...
     *
     * @return a {@link Map} containing the number of nodes for each sysOid
     */
