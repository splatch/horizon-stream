...
public class NodeTypeUserType extends EnumType {
    ...
    public Object nullSafeGet(ResultSet rs, String[] names, SharedSessionContractImplementor session, Object owner) throws SQLException {
        ...
        for (OnmsNode.NodeType type : OnmsNode.NodeType.values()) {
    ...
    public void nullSafeSet(PreparedStatement st, Object value, int index, SharedSessionContractImplementor session) throws HibernateException, SQLException {
        ...
        } else if (value instanceof OnmsNode.NodeType){
            CharacterType.INSTANCE.nullSafeSet(st, ((OnmsNode.NodeType)value).toString().charAt(0), index, session);
    ...
    @Override
    public Class<OnmsNode.NodeType> returnedClass() {
        return OnmsNode.NodeType.class;
    }
