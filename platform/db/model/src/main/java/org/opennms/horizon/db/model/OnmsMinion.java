...
public class OnmsMinion extends OnmsMonitoringSystem {
    ...
    public OnmsMinion(final String id, final String location, final Date lastUpdated) {
        super(id, location);
    ...
    public String toString() {
        return "OnmsMinion [id=" + getId() + ", location=" + getLocation() + ", lastUpdated=" + getLastUpdated() + ", properties=" + getProperties() + "]";
    }
}
