 ...
 * {@link org.opennms.horizon.jmx.connection.JmxServerConnector}
 * implementation according to the connectionName and establish a connection using that server connector.
 * <p/>
 * If no {@link org.opennms.horizon.jmx.connection.JmxServerConnector} could be used for a given
...
public interface JmxConnectionManager {
     ...
     * {@link org.opennms.horizon.jmx.connection.JmxServerConnector} registered with <code>connectionString</code>.
     * <p/>
     * If the connection to the server could not be established (e.g. no retries left) a JmxServerConnectionException is thrown.
     *
     * @param connectionName       The {@link org.opennms.horizon.jmx.connection.JmxConnectors} name of the connection. May be null.
     ...
     * the {@link org.opennms.horizon.jmx.connection.JmxServerConnector#createConnection(InetAddress, Map)}
     * method.
     * <p/>
