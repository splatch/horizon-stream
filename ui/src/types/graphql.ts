...
export type GetMinionUptimeQueryVariables = Exact<{ [key: string]: never; }>;


export type GetMinionUptimeQuery = { __typename?: 'Query', minionUptime?: { __typename?: 'TimeSeriesQueryResult', data?: { __typename?: 'TSData', result?: Array<{ __typename?: 'TSResult', metric?: any, value?: Array<number> }> } } };
...
export const GetMinionUptimeDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMinionUptime"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"MinionUptimeParts"}}]}},...MinionUptimePartsFragmentDoc.definitions,...MetricPartsFragmentDoc.definitions]} as unknown as DocumentNode<GetMinionUptimeQuery, GetMinionUptimeQueryVariables>;
