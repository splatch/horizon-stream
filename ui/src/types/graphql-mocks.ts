...
export type ListMinionsQuery = { __typename?: 'Query', listMinions: { __typename?: 'ListMinions', count: string, totalCount: string, offset: string, items: Array<{ __typename?: 'Minion', id: string, label: string, status: string, location: string, date: string, icmp_latency: string, snmp_uptime: string }> } };
