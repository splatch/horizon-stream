...
export const REGEX_EXPRESSIONS = {
  ...
  IP: [
    ...
    /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(?:-(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)|(?:2[0-9]|[01]?[0-9])\/\d{1,2}))?$/,
    /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(?:\/(?:[0-9]|[1-2][0-9]|3[0-2]))?$/,
    /^(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(?:\.|$)){4}(?:\d+(?:-(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)|(?:2[0-9]|[01]?[0-9])))?)+$/
  ]
}
