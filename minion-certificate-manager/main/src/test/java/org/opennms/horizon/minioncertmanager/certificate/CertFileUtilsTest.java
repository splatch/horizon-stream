...
public class CertFileUtilsTest {
    ...
    public void testCreateZipFile() throws Exception {
        Files.createFile(tempDir.resolve("client.key")).toFile();
        var caCertFile = Files.createFile(tempDir.resolve("CA.cert")).toFile();
        Files.createFile(tempDir.resolve("client.signed.cert")).toFile();

        File file = new File(tempDir.toFile(), "minioncert.zip");
        String password = "password";

        certFileUtils.createZipFile(file, password, tempDir.toFile(), caCertFile);
