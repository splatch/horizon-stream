...
Feature: IT Engineer with the MEMBER role can only see data in Portal
  ...
  Scenario: IT Engineer cannot edit OpenNMS Cloud instance
    Given BTO instance named "CLOUD-T581" is assigned to "MEMBER" user
  ...
  Scenario: IT Engineer cannot delete OpenNMS Cloud instance
    Given BTO instance named "CLOUD-T582" is assigned to "MEMBER" user
  ...
  Scenario: IT Engineer can add user to OpenNMS Cloud instance
    Given BTO instance named "CLOUD-T583" is assigned to "MEMBER" user
  ...
  Scenario: IT Engineer sees OpenNMS Cloud instance based on membership
    Given BTO instance named "CLOUD-T584-ADMIN" is assigned to "ADMIN" user
    And BTO instance named "CLOUD-T584-MEMBER" is assigned to "MEMBER" user
    And BTO instance named "CLOUD-T584-OKTA" is assigned to "OKTA_USER" user
  ...
  Scenario: IT Engineer will see new assigned instances when page is refreshed
    Given BTO instance named "CLOUD-T585" is assigned to "MEMBER" user
    And BTO instance named "CLOUD-T585-new" is created
  ...
  Scenario: IT Engineer no longer sees OpenNMS Cloud instance after revoke
    Given BTO instance named "CLOUD-T586" is assigned to "MEMBER" user
    And BTO instance named "CLOUD-T586-revoked" is assigned to "MEMBER" user
