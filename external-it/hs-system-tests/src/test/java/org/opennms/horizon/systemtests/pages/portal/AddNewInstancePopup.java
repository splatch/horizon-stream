...
public class AddNewInstancePopup {
    ...
    private static final SelenideElement popup = $(By.id("cloud-add-instance-dialog"));
    private static final SelenideElement instanceNameInp = $(By.id("cloud-add-instance-dialog-name"));
    ...
    private static final SelenideElement meOption = $(By.id("cloud-add-instance-me"));
    private static final SelenideElement someoneElseOption = $(By.id("cloud-add-instance-someoneelse"));
    private static final SelenideElement anotherEmailInp = $(By.id("cloud-add-instance-dialog-email-with"));
    ...
    private static final SelenideElement cancelBtn = $(By.id("cloud-add-instance-cancel"));
    private static final SelenideElement submitBtn = $(By.id("cloud-add-instance-confirm"));
